...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/23 17:57:27 by vitenner          #+#    #+#             */
/*   Updated: 2024/09/23 17:57:27 by vitenner         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_outro(t_game *game)
{
	...
	outro_texture = &game->t_outro[frame_to_render];
	if (outro_texture->img == NULL)
		return ;
	render_texture(game, &game->t_outro[frame_to_render]);
