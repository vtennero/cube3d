...
void calculate_health_bar_dimensions(t_game *game, int *width, int *height, int *start_x, int *start_y)
{
...
void draw_health_bar_border(t_game *game, int start_x, int start_y, int width, int height)
{
...
void draw_health_bar_fill(t_game *game, int start_x, int start_y, int width, int height)
{
    int color = 0x00FF00;  // Green color
    int fill_width = (game->player->hp * (width - 2 * HEALTH_BAR_BORDER)) / MAX_HEALTH;
    
    for (int y = start_y + HEALTH_BAR_BORDER; y < start_y + height - HEALTH_BAR_BORDER; y++)
    {
        for (int x = start_x + HEALTH_BAR_BORDER; x < start_x + HEALTH_BAR_BORDER + fill_width; x++)
        {
